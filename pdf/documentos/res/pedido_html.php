...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
	...
	<table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
		<tr>
			...
			<td class='pumpkin' style="width:34%; ">NUMERO DE ABONO</td>
...
while ($row=mysqli_fetch_array($sql))
	...
	?>
        ...
        <tr>
            <td class='<?php echo $clase;?>' style="width: 14%; text-align: center"><?php echo $referencia; ?></td>
	...
	$insert_detail=mysqli_query($con, "INSERT INTO tbl_detalle_pedido VALUES ('','$numero_pedido','$id_producto','$cantidad','$precio_venta_r')");
	$nums++;
	}
